...
I'm focusing on the user's request. They want to include the "executed quantity" in the log. So, I'll add `order.executed.size` to the log message, formatted as a whole number.
