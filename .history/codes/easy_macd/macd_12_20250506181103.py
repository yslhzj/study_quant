...
class TradeLinesObserver(bt.Observer):
    ...
    # 配置绘图样式
    plotlines = dict(
        long_entry=dict(_name='Buy', marker='*', markersize=8, color='lime', plotymargin=0.10,
                        fillstyle='full', ls='', linewidth=1),
        long_exit=dict(_name='Sell', marker='v', markersize=8, color='red', plotymargin=0.10,
                       fillstyle='full', ls='-', linewidth=1),
        short_entry=dict(_name='Short', marker='o', markersize=8, color='blue', plotymargin=0.10,
                         fillstyle='full', ls='', linewidth=1),
        short_exit=dict(_name='Cover', marker='^', markersize=8, color='yellow', plotymargin=0.10,
                        fillstyle='full', ls='--', linewidth=1)
    )
