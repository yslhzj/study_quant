...
class AShareETFStrategy(bt.Strategy):
    ...
    def notify_cashvalue(self, cash, value):
        ...
        if not self.in_trade_halt and self.drawdown >= self.p.trade_halt_drawdown_percent:
            ...
            self.log(
                f"*** TRADE HALT TRIGGERED due to drawdown exceeding {self.p.trade_halt_drawdown_percent:.1%} ***")
            ...
            self.log(
                f"*** TRADING RESUMED as drawdown is below {self.p.trade_resume_threshold:.1%} ***")
        # --- End Log ---
