...
if __name__ == '__main__':
    ...
    column_mapping = {'datetime': 'datetime', '开盘': 'open',
    ...
    trend_sl_atr_mult_range = np.arange(2.0, 3.1, 0.5)
    ...
    if optimize:
        ...
        print(
            f"  trend_stop_loss_atr_mult: {list(np.round(trend_sl_atr_mult_range,1))}")
        print('-' * 50)
        ...
        results = cerebro.run(maxcpus=max(
