...
class DemoStrategy(bt.Strategy):
    def __init__(self):
        ...
        # self.sma.plotinfo.plotlinelabels = False  # 6. 是否显示线名，True 表示在图上标出线名
        self.sma.plotinfo.plotlinelabels = True  # 6. 是否显示线名，True 表示在图上标出线名
        self.sma.plotinfo.plotlinevalues = False  # 7. 是否显示数值，True 表示在图上显示数值
        # self.sma.plotinfo.plotlinevalues = True  # 7. 是否显示数值，True 表示在图上显示数值
        self.sma.plotinfo.plotvaluetags = False  # 8. 是否显示标签，True 表示在图上加标签
        # self.sma.plotinfo.plotvaluetags = True  # 8. 是否显示标签，True 表示在图上加标签
        self.sma.plotinfo.plotymargin = 0.6  # 9. y轴边距，0.1 表示上下各留10%的空白
        self.sma.plotinfo.plotyhlines = [20, 50, 80]  # 10. y轴加三条横线
        self.sma.plotinfo.plotyticks = [0, 20, 40, 60, 80, 100,120]  # 11. y轴刻度自定义
